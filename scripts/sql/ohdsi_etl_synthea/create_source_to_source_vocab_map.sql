...
if object_id('@cdm_schema.int__source_to_source_vocab_map', 'U')  is not null drop table @cdm_schema.int__source_to_source_vocab_map;
...
WITH CTE_VOCAB_MAP AS (
       ...
       FROM @cdm_schema.stg_vocabulary__source_to_standard_vocab_map stcm
...
SELECT * INTO @cdm_schema.int__source_to_source_vocab_map FROM CTE_VOCAB_MAP;

create index idx_source_vocab_map_source_code on @cdm_schema.int__source_to_source_vocab_map (source_code);
create index idx_source_vocab_map_source_vocab_id on @cdm_schema.int__source_to_source_vocab_map (source_vocabulary_id);

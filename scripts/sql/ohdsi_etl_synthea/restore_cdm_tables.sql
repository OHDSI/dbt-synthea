...
if object_id('@cdm_schema.stg_vocabulary__source_to_standard_vocab_map', 'U') is not null rename object @cdm_schema.stg_vocabulary__source_to_standard_vocab_map to stg_vocabulary__source_to_standard_vocab_map_old;
...
if object_id('@cdm_schema.stg_vocabulary__source_to_standard_vocab_map_orig', 'U') is not null rename object @cdm_schema.stg_vocabulary__source_to_standard_vocab_map_orig to stg_vocabulary__source_to_standard_vocab_map;
...
if object_id('@cdm_schema.stg_vocabulary__source_to_standard_vocab_map_old', 'U') is not null drop table @cdm_schema.stg_vocabulary__source_to_standard_vocab_map_old;

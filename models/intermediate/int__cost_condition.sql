...
SELECT
    ...
    , {{ dbt.cast("payer_paid ", api.Column.translate_type("decimal")) }} + {{ dbt.cast("patient_paid", api.Column.translate_type("decimal")) }} AS total_charge
    , {{ dbt.cast("payer_paid ", api.Column.translate_type("decimal")) }} + {{ dbt.cast("patient_paid", api.Column.translate_type("decimal")) }} AS total_cost
